...
urlpatterns = [
    ...
    path("movies/<int:pk>/add_to_watchlist/", add_to_watchlist, name="add-to-watchlist"),
    path("movies/<int:pk>/mark_as_watched/", mark_as_watched, name="mark-as-watched"),
    path("movies/<int:pk>/remove_from_watchlist/", remove_from_watchlist, name="remove-from-watchlist"),
    path("movies/<int:pk>/watched/remove/", remove_from_watched, name="remove-from-watched"),
]
